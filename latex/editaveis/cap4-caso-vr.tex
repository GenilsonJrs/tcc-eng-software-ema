...
\begin{itemize}
	...
	\item \textbf{Risco quanto aos \emph{assets}:} necessidade de verificar, na etapa de
	      reativação, a disponibilidade e a integridade dos modelos e recursos gráficos do
	      avatar.
\end{itemize}
